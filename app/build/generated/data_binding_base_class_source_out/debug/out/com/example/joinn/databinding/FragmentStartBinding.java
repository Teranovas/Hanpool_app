...
public final class FragmentStartBinding implements ViewBinding {
  ...
  private FragmentStartBinding(@NonNull ConstraintLayout rootView, @NonNull WebView webView1) {
  ...
  public static FragmentStartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentStartBinding((ConstraintLayout) rootView, webView1);
    }
