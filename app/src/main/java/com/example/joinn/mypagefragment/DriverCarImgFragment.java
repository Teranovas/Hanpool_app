...
public class DriverCarImgFragment extends Fragment {

    private Context context;

    private ImageView carImg1, carImg2, carImg3;

    private Button carImgBtn, nextBtn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_driver_car_img, container, false);

        carImgBtn = view.findViewById(R.id.carImgBtn);
        nextBtn = view.findViewById(R.id.nextBtn);
        carImg1 = view.findViewById(R.id.carImg1);
        carImg2 = view.findViewById(R.id.carImg2);
        carImg3 = view.findViewById(R.id.carImg3);
    ...
    public void uploadImageToFirebase(ImageView imageView){
        if (imageView.getDrawable() != null) {

            String fileName = user.getUid() + "CarImage" + num + ".jpg";
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            carImg1.setImageBitmap(imageBitmap);
